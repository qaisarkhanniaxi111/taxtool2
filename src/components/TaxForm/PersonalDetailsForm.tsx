...
const PersonalDetailsForm = () => {
  ...
  const [spouseInfo, setSpouseInfo] = useState<PersonalInfo>({
    firstName: '',
    middleName: '',
    lastName: '',
    dateOfBirth: '',
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <InputField
                ...
                onChange={(e) => setSpouseInfo({ ...spouseInfo, firstName: e.target.value })}
                required
              />
              <InputField
                label="Middle Name"
                ...
                onChange={(e) => setSpouseInfo({ ...spouseInfo, middleName: e.target.value })}
              />
              <InputField
                label="Last Name"
                name="spouseLastName"
                value={spouseInfo.lastName}
                onChange={(e) => setSpouseInfo({ ...spouseInfo, lastName: e.target.value })}
                required
              />
              <InputField
                label="Date of Birth"
                ...
                onChange={(e) => setSpouseInfo({ ...spouseInfo, dateOfBirth: e.target.value })}
                type="date"
                required
              />
              <InputField
